...
import com.example.appdt.adapter.DienThoaiAdapter;
...
//        compositeDisposable.add(appBanHang.getSanpham(page,loai)
//        .subscribeOn(Schedulers.io())
//        .observeOn(AndroidSchedulers.mainThread())
//        .subscribe(
//                sanPhamMoiModel -> {
//                    if (sanpham.isSuccess()){
//                        if (adapterDt == null){
...
//
//                    }else {
//                        Toast.makeText(getApplicationContext(),"Hết dữ liệu", Toast.LENGTH_LONG
//                        ).show();
//                        isLoading = true;
//                    }
//                },
