            ...
            public void onImageClick(View view, int pos, int giatri) {
                ...
                if(giatri==1) {
                    if (gioHangList.get(pos).getSoluong() > 1) {
                        ...
                        builder.setMessage("Bạn có muốn xóa sản phẩm khỏi giỏ hàng hay không");
                        builder.setPositiveButton("Đồng y", new DialogInterface.OnClickListener() {
                            @Override
...
imageClickListener listener;
        public MyViewHoder(@NonNull View itemView) {
            super(itemView);
            item_giohang_image = itemView.findViewById(R.id.item_giohang_imge);
            item_giohang_tensp = itemView.findViewById(R.id.item_giohang_tensp);
            item_giohang_gia = itemView.findViewById(R.id.tiem_giohang_giasp);
